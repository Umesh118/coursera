...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.promotionService
      ...
      .subscribe((promotion) => (this.promotion = promotion), errmess => this.promotionErrMsg = <any>errmess);
    this.leaderService
      .getFeaturedLeader()
      .subscribe((leader) => (this.leader = leader), errmess => this.leaderErrMsg = <any>errmess);
  }
}
